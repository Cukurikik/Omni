...
3. Agent akan **register** ke master dan muncul dengan status _Pending_.
...
- **Master API key** – melindungi administrative API. UI hanya menampilkannya setelah Anda mengklik _Show master API key_.
