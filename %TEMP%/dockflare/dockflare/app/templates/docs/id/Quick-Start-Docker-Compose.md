...
4. _(Opsional)_ Me-restore dari arsip backup DockFlare. Jika Anda sudah punya `dockflare_backup_*.zip`, pilih **Restore from backup** sebelum Step 1; wizard akan mengimpor konfigurasi dan merestart container secara otomatis.
