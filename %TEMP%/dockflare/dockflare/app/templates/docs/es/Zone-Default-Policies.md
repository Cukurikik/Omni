...
5. Verifique los registros de acceso de Cloudflare para conocer el orden de evaluación de políticas
6. Asegúrese de que el registro DNS apunte al túnel correcto.
