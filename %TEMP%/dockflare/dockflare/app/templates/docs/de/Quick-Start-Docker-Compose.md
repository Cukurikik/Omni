...
4. _(Optional)_ Wiederherstellung aus einem DockFlare-Backuparchiv. Wenn Sie bereits eine `dockflare_backup_*.zip` besitzen, wählen Sie vor Schritt 1 **Restore from backup** aus; der Assistent importiert Ihre Konfiguration und startet den Container automatisch neu.
