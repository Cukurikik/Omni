...
function runOracleApi() {
  ...
  console.log(
    `⚠️  Ditemukan ${ghostEndpoints.length} Ghost Endpoint! Membangun Handler Mock...`,
  );
  ...
  console.log(
    `✅ [ORACLE SYNC] ${ghostEndpoints.length} Mock Handler berhasil dijahit ke oracle_mocks.go.`,
  );
}
