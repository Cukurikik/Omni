// omni-cloudflare-workers â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-cloudflare-workers', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
