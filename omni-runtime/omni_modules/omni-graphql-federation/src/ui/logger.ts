// omni-graphql-federation â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-graphql-federation', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
