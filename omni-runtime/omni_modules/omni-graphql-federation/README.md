...
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-graphql-federation)
...
```omni
import { init, create_client } from "omni-graphql-federation"
