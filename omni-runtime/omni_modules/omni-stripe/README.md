...
> Stripe payment processing with charges, subscriptions, webhooks

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-stripe)
...
```omni
import { init, create_client } from "omni-stripe"
