...
> Declarative motion library for OMNI UI components

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-framer-motion)
...
```omni
import { init, create_client } from "omni-framer-motion"
