...
> Three.js WebGL 3D rendering engine with OMNI shader pipeline

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-threejs)
...
```omni
import { init, create_client } from "omni-threejs"
