...
> Apache Kafka client with exactly-once semantics

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-kafka-stream)
...
```omni
import { init, create_client } from "omni-kafka-stream"
