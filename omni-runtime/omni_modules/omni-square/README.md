...
> Square payment SDK for terminals, invoices, and catalog

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-square)
...
```omni
import { init, create_client } from "omni-square"
