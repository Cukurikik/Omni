// omni-azure-functions â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-azure-functions', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
