...
> Heroku platform SDK for dyno management and pipelines

**Category:** Cloud and Object Storage
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-heroku-dynos)
...
```omni
import { init, create_client } from "omni-heroku-dynos"
