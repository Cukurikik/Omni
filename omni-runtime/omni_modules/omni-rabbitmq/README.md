...
> RabbitMQ AMQP client with exchanges and dead-letter queues

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-rabbitmq)
...
```omni
import { init, create_client } from "omni-rabbitmq"
