...
> Embedded SQLite3 with WAL mode, FTS5, and zero-copy I/O

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-sqlite-turbo)
...
```omni
import { init, create_client } from "omni-sqlite-turbo"
