...
> SVG path morphing and shape interpolation engine

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-svg-morph)
...
```omni
import { init, create_client } from "omni-svg-morph"
