...
> TimescaleDB hypertable driver with continuous aggregates

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-timescaledb)
...
```omni
import { init, create_client } from "omni-timescaledb"
