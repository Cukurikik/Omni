// omni-firebase-native â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-firebase-native', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
