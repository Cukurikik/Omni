...
> Typewriter animation engine with cursor and loop control

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-typed-js)
...
```omni
import { init, create_client } from "omni-typed-js"
