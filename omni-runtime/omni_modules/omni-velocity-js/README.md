...
> Velocity.js animation engine with spring physics

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-velocity-js)
...
```omni
import { init, create_client } from "omni-velocity-js"
