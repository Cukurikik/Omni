// omni-oracle-cloud-obj â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-oracle-cloud-obj', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
