// omni-digitalocean-spaces â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-digitalocean-spaces', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
