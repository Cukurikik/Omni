# omni-digitalocean-spaces

> DigitalOcean Spaces S3-compatible object storage SDK

**Category:** Cloud and Object Storage
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-digitalocean-spaces)
...
```omni
import { init, create_client } from "omni-digitalocean-spaces"
