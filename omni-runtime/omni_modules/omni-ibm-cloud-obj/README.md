...
> IBM Cloud Object Storage, S3-compatible with Aspera

**Category:** Cloud and Object Storage
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-ibm-cloud-obj)
...
```omni
import { init, create_client } from "omni-ibm-cloud-obj"
