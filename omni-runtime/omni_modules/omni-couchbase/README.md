...
> Couchbase SDK with N1QL query and full-text search

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-couchbase)
...
```omni
import { init, create_client } from "omni-couchbase"
