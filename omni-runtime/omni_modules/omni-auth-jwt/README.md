...
> JWT authentication with sign, verify, refresh, JWKS

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-auth-jwt)
...
```omni
import { init, create_client } from "omni-auth-jwt"
