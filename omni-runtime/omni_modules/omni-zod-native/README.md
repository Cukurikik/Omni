...
> Schema validation with type inference and transforms

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-zod-native)
...
```omni
import { init, create_client } from "omni-zod-native"
