...
> Lodash utility functions compiled to native LLVM

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-lodash-native)
...
```omni
import { init, create_client } from "omni-lodash-native"
