...
> Afterpay/Clearpay installment payments and refunds

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-afterpay)
...
```omni
import { init, create_client } from "omni-afterpay"
