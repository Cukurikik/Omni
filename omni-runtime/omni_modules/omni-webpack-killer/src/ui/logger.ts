// omni-webpack-killer â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-webpack-killer', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
