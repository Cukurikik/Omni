...
> OMNI native bundler with tree-shaking and HMR

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-webpack-killer)
...
```omni
import { init, create_client } from "omni-webpack-killer"
