# omni-nodemailer-native

> Email sending with SMTP, OAuth2, templates, DKIM

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-nodemailer-native)
...
```omni
import { init, create_client } from "omni-nodemailer-native"
