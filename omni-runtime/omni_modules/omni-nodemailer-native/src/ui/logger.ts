// omni-nodemailer-native â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-nodemailer-native', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
