...
> WOW.js scroll animation triggers with CSS3 integration

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-wow-js)
...
```omni
import { init, create_client } from "omni-wow-js"
