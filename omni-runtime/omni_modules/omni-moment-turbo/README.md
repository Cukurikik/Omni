...
> High-performance date/time library, immutable with IANA TZ

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-moment-turbo)
...
```omni
import { init, create_client } from "omni-moment-turbo"
