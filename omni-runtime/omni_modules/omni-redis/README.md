...
> Redis client with cluster mode, pub/sub, and Lua scripting

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-redis)
...
```omni
import { init, create_client } from "omni-redis"
