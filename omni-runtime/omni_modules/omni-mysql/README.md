...
> MySQL/MariaDB driver with binary protocol and pooling

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-mysql)
...
```omni
import { init, create_client } from "omni-mysql"
