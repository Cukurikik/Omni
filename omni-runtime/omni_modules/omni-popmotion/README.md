...
> Functional reactive animation library with physics

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-popmotion)
...
```omni
import { init, create_client } from "omni-popmotion"
