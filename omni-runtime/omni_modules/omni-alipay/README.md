...
> Alipay global payment for mini programs and cross-border

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-alipay)
...
```omni
import { init, create_client } from "omni-alipay"
