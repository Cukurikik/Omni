...
> Paystack Africa payment for cards, bank, and mobile money

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-paystack)
...
```omni
import { init, create_client } from "omni-paystack"
