# omni-prettier-native

> Code formatter for OMNI, TS, CSS, HTML, GraphQL

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-prettier-native)
...
```omni
import { init, create_client } from "omni-prettier-native"
