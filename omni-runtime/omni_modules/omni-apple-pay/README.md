...
> Apple Pay integration for payment sessions and tokens

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-apple-pay)
...
```omni
import { init, create_client } from "omni-apple-pay"
