# omni-dynamodb-native

> AWS DynamoDB SDK with single-table design helpers

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-dynamodb-native)
...
```omni
import { init, create_client } from "omni-dynamodb-native"
