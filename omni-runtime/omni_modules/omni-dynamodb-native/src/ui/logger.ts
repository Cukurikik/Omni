// omni-dynamodb-native â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-dynamodb-native', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
