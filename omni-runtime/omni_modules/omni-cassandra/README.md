...
> Apache Cassandra driver with tunable consistency

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-cassandra)
...
```omni
import { init, create_client } from "omni-cassandra"
