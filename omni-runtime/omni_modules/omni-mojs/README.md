...
> Motion graphics toolbelt for burst, shape, and timeline

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-mojs)
...
```omni
import { init, create_client } from "omni-mojs"
