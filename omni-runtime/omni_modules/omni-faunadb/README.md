...
> Fauna serverless database SDK with FQL v10 query builder

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-faunadb)
...
```omni
import { init, create_client } from "omni-faunadb"
