// omni-image-optimizer â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-image-optimizer', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
