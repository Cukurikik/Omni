...
> MongoDB native driver with aggregation pipeline and change streams

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-mongodb)
...
```omni
import { init, create_client } from "omni-mongodb"
