...
> USDC stablecoin SDK with mint, burn, transfer, Circle API

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-crypto-usdc)
...
```omni
import { init, create_client } from "omni-crypto-usdc"
