...
> Elasticsearch client with full-text search and DSL builder

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-elastic-search)
...
```omni
import { init, create_client } from "omni-elastic-search"
