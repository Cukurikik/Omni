// omni-elastic-search â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-elastic-search', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
