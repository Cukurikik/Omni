...
> PayPal REST SDK for orders, payouts, and subscriptions

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-paypal)
...
```omni
import { init, create_client } from "omni-paypal"
