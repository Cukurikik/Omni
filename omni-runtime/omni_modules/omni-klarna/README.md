...
> Klarna buy-now-pay-later for checkout and order management

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-klarna)
...
```omni
import { init, create_client } from "omni-klarna"
