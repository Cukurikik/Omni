...
class OmniVertexTelepathyBridge {
    ...
    async analyzeAndHealAST(astNode) {
        console.log(`🧠 [OMNI TELEPATHY] Memulai analisa siklus pada Node: ${astNode.id}`);
        ...
        try {
            ...
            console.log(`✨ [OMNI TELEPATHY] PGO (Profile-Guided Optimization) Heuristic Generated via Vertex AI.`);
