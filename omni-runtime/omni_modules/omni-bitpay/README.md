...
> BitPay crypto payments for invoices and settlements

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-bitpay)
...
```omni
import { init, create_client } from "omni-bitpay"
