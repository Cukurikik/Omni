...
> Razorpay payment gateway for UPI, cards, and wallets

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-razorpay)
...
```omni
import { init, create_client } from "omni-razorpay"
