...
> Pinecone vector database SDK for semantic search at scale

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-pinecone)
...
```omni
import { init, create_client } from "omni-pinecone"
