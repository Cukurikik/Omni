...
> PDF generation engine with templates, tables, charts

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-pdf-generator)
...
```omni
import { init, create_client } from "omni-pdf-generator"
