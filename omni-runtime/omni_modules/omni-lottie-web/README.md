...
> Lottie/Bodymovin JSON animation renderer for web

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-lottie-web)
...
```omni
import { init, create_client } from "omni-lottie-web"
