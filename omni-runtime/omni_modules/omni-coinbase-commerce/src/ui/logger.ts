// omni-coinbase-commerce â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-coinbase-commerce', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
