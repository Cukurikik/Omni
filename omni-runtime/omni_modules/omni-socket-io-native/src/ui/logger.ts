// omni-socket-io-native â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-socket-io-native', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
