# omni-socket-io-native

> Socket.IO native client/server with namespaces and rooms

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-socket-io-native)
...
```omni
import { init, create_client } from "omni-socket-io-native"
