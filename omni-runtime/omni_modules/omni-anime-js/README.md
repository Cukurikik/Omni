...
> Lightweight animation engine for CSS, SVG, DOM, and JS

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-anime-js)
...
```omni
import { init, create_client } from "omni-anime-js"
