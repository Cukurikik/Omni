// omni-rive-animation â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-rive-animation', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
