...
> Rive runtime for interactive vector animations

**Category:** Animation and UI
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-rive-animation)
...
```omni
import { init, create_client } from "omni-rive-animation"
