...
> InfluxDB time-series client with Flux query support

**Category:** Database and Data Store
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-influxdb)
...
```omni
import { init, create_client } from "omni-influxdb"
