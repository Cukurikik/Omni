...
> Authorize.Net payment for credit cards, ACH, fraud detection

**Category:** Payment and Financial
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-authorize-net)
...
```omni
import { init, create_client } from "omni-authorize-net"
