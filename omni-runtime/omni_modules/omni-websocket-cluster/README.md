# omni-websocket-cluster

> WebSocket cluster manager with rooms and broadcast

**Category:** Core Utility and Infra
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-websocket-cluster)
...
```omni
import { init, create_client } from "omni-websocket-cluster"
