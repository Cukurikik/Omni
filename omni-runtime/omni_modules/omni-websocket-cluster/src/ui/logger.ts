// omni-websocket-cluster â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-websocket-cluster', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
