...
> Tencent Cloud COS with CDN and media processing

**Category:** Cloud and Object Storage
**Version:** 1.0.0
**License:** OMNI-Community
**Registry:** [OMNI-NEXUS](https://nexus.omniframework.dev/packages/omni-tencent-cos)
...
```omni
import { init, create_client } from "omni-tencent-cos"
