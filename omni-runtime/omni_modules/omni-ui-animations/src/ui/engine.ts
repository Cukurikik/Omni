...
export const AnimationPresets = {
    fadeIn: { duration: 300, easing: "ease-in", stagger: false } as AnimationConfig,
    slideUp: { duration: 400, easing: "cubic-bezier(0.4, 0, 0.2, 1)", stagger: false } as AnimationConfig,
    slideIn: { duration: 350, easing: "ease-out", stagger: false } as AnimationConfig,
    staggerReveal: { duration: 500, easing: "ease-in-out", stagger: true } as AnimationConfig,
    bounceIn: { duration: 600, easing: "cubic-bezier(0.68, -0.55, 0.265, 1.55)", stagger: false } as AnimationConfig,
};
