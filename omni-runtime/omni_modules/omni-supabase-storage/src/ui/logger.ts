// omni-supabase-storage â€” Client-Side Logger
...
export class Logger {
  ...
  constructor(prefix: string = 'omni-supabase-storage', level: LogLevel = LogLevel.INFO) { this.prefix = prefix; this.level = level; }
