...
- Darwin:
    ...
    - jruby 9.0.3.0 (2.2.2) 2015-10-21 633c9aa Java HotSpot(TM) 64-Bit Server VM 25.11-b03 on 1.8.0_11-b12 +jit [darwin-x86\_64]
...
- The program only uses _infinite_ loops and no `break`.
...
- The program does not want any _argument_ with you and will quit quietly if you try some.
