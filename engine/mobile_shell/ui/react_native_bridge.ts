...
class OmniReactNativeBridge {
    ...
    constructor() {
        console.log("📱 [OMNI-RN-TS] Menghidupkan JSI (JavaScript Interface) Bridge...");
        console.log("   -> Menghubungkan TypeScript UI ke C++ NDK tanpa JSON overhead!");
    }
...
console.log("🔋 JSI Bridge: 10x lebih cepat dari JSON Bridge lama React Native!");
