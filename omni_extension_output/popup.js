document.addEventListener('DOMContentLoaded', () => {
    ...
    firewallBtn.addEventListener('click', () => {
        ...
        if(malicious) {
            outputEl.innerHTML = "<span style='color:red;'>⛔ SECURITY HALT: Prompt Injection diblokir!</span>";
            execBtn.disabled = true;
        } else {
            outputEl.innerHTML = "<span style='color:#66fcf1;'>✅ Input Aman. Melanjutkan...</span>";
