// OMNI Interface Layer: Prompt optimization and DSP metric computation API
// Fully typed TypeScript interface matching C++ kernel output

export interface OmniResult_dspy {
    value: number;
    error_code: number;
    error_message: string | null;
}

export class dspyAPI {
    /**
     * Invokes the Prompt optimization and DSP metric computation core kernel natively.
     * @param data Array of numerical input representing system state
     */
    public static async process(data: number[]): Promise<OmniResult_dspy> {
