...
if __name__ == '__main__':
    print('======================================================================')
    print('  BATCH 78 -- SEMESTER 9 DIAGNOSTICS (BATCH 29)')
    print('======================================================================')
    registry = OmniEngineRegistry(r'c:\Users\IKYY\Downloads\Omni\src')
    registry.scan()
    batch29_engines = [
        'omni_audio_streaming_engine', 
        'omni_media_downloader_engine', 
        'omni_audio_processing_engine', 
        'omni_audio_library_engine',
        'omni_audio_interface_engine'
    ]
    all_passed = True
    for eng_name in batch29_engines:
    ...
    print('\n======================================================================')
    if all_passed:
        print('  [OK]  ALL 5 ENGINES OPERATIONAL -- Batch 78 PASSED')
    else:
