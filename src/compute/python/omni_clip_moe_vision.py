...
# OMNI MOTHER: CLIP-MoE Vision Encoder
# Implements MoE layers within the ViT blocks of CLIP

class OmniCLIPVisionMoE(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        # x is image patches [batch, patches, embed_dim]
